...
Turn_On
	...
	movlw	0x8F
	addwf	COUNT,f		; increments count by 2
	btfsc 	STATUS,C	; skip if carry bit is off
	goto 	Inc_Brightness	; runs if counter overflows
;	goto 	Turn_On_Next	; otherwise turn on LED

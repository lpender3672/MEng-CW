...
If the flow did seperate, the seperation bubble should show a deviation from the inviscid solution. [?] % REVISIT
...
This is a different order of magnitude. % REVISIT

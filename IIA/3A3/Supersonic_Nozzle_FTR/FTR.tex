...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../Supersonic_Nozzle/pressure_ratio_distribution_corrected.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../Supersonic_Nozzle/mach_number_distribution_corrected.png}
    \caption{Static pressure ratio distribution along the nozzle.}
...
\begin{equation}
    ...
    \label{eqn:dp0sr_dm}
\end{equation}
\footnotetext{Derivative equations \ref{eqn:dp0sr_dm} and \ref{eqn:dA_dM} were generated using SymPy from databook \cite{data_book} equations}

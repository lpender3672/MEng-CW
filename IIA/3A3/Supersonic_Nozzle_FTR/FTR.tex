...
To simplify the analysis the densities of water and mercury are assumed to be negligible.
...
Layout of the supersonic wind tunnel is shown in figure \ref{fig:supersonic_tunnel}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{tunnel_layout_placeholder.png}
...
One dimensional flow theory shows good agreement experimental results for convergent divergent nozzle flows.
